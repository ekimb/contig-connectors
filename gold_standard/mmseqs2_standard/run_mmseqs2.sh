...
python filter_blast_6_to_containments.py -i mmseqs2_result.b6 -q query/query.ml500.fna.fai -r reference/reference.ml500.fna.fai -o mmseqs2_marine_containments.b6
...
python filter_blast_6_to_containments.py -i blastn_result.b6 -q query/query.ml500.fna.fai -r reference/reference.ml500.fna.fai -o blastn_marine_containments.b6
